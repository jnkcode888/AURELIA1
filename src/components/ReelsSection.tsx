      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {reels.map((reel, index) => <div key={index} className="group relative rounded-lg overflow-hidden aspect-[9/16] bg-black/30 backdrop-blur-sm border border-white/10 hover:border-electric-blue/50 transition-all duration-300">
                ...
                <div className="absolute bottom-4 left-4 right-4">
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    <div className="flex space-x-1">
                      {[...Array(5)].map((_, i) => <div key={i} className="w-1 h-4 bg-electric-blue/70 rounded-full" style={{
